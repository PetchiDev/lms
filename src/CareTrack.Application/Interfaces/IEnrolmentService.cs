...
public interface IEnrolmentService
{
    ...
    Task<CsvImportResult> ImportStudentsAsync(Stream fileStream, string fileName, Guid cohortId, CancellationToken cancellationToken = default);
    ...
    Task<StudentEnrolmentResponse> UpdateStudentAsync(Guid studentId, UpdateStudentRequest request, CancellationToken cancellationToken = default);
