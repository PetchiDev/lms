    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgrammeYears", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProgrammeYears_Programmes_ProgrammeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cohorts_Universities_UniversityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UniversityProgrammes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UniversityProgrammes_Programmes_ProgrammeId",
                        column: x => x.ProgrammeId,
                        principalTable: "Programmes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UniversityProgrammes_Universities_UniversityId",
                        column: x => x.UniversityId,
                        principalTable: "Universities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProgrammeYearId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Semesters_ProgrammeYears_ProgrammeYearId",
                        column: x => x.ProgrammeYearId,
                        principalTable: "ProgrammeYears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentEnrolments_Cohorts_CohortId",
                        column: x => x.CohortId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentEnrolments_Universities_UniversityId",
                        column: x => x.UniversityId,
                        principalTable: "Universities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ModuleId = table.Column<Guid>(type: "uuid", nullable: false),
                    PrerequisiteModuleId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModulePrerequisites", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ModulePrerequisites_Modules_PrerequisiteModuleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfflineAssessmentResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OfflineAssessmentResults_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OfflineAssessmentResults_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContentPublications_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContentPublications_Universities_UniversityId",
                        column: x => x.UniversityId,
                        principalTable: "Universities",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cohorts_UniversityId_Name",
                table: "Cohorts",
                columns: new[] { "UniversityId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ContentPublications_LessonId_UniversityId",
                table: "ContentPublications",
                columns: new[] { "LessonId", "UniversityId" });

            migrationBuilder.CreateIndex(
                name: "IX_ContentPublications_UniversityId",
                table: "ContentPublications",
                column: "UniversityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModulePrerequisites_ModuleId_PrerequisiteModuleId",
                table: "ModulePrerequisites",
                columns: new[] { "ModuleId", "PrerequisiteModuleId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ModulePrerequisites_PrerequisiteModuleId",
                table: "ModulePrerequisites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfflineAssessmentResults_ModuleId",
                table: "OfflineAssessmentResults",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_OfflineAssessmentResults_StudentId",
                table: "OfflineAssessmentResults",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgrammeYears_ProgrammeId_YearNumber",
                table: "ProgrammeYears",
                columns: new[] { "ProgrammeId", "YearNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Semesters_ProgrammeYearId_SemesterNumber",
                table: "Semesters",
                columns: new[] { "ProgrammeYearId", "SemesterNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudentEnrolments_CohortId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentEnrolments_UniversityId_CohortId",
                table: "StudentEnrolments",
                columns: new[] { "UniversityId", "CohortId" });

            migrationBuilder.CreateIndex(
                name: "IX_StudentEnrolments_UniversityId_StudentId",
                table: "StudentEnrolments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Universities_Domain",
                table: "Universities",
                column: "Domain",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UniversityProgrammes_ProgrammeId",
                table: "UniversityProgrammes",
                column: "ProgrammeId");

            migrationBuilder.CreateIndex(
                name: "IX_UniversityProgrammes_UniversityId_ProgrammeId",
                table: "UniversityProgrammes",
                columns: new[] { "UniversityId", "ProgrammeId" },
                unique: true);
        }
